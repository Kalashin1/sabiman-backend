...
user_1["default"].statics.login = function (phoneNumber, password) {
    return __awaiter(this, void 0, void 0, function () {
        var user, result;
...
user_1["default"].statics.editProfile = function (_id, obj) {
    return __awaiter(this, void 0, void 0, function () {
        var user, country, state, phoneNumber, name;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mongoose.model('user').findById(_id)];
                case 1:
                    user = _a.sent();
                    country = obj.country, state = obj.state, phoneNumber = obj.phoneNumber, name = obj.name;
...
user_1["default"].methods.resetPassword = function (oldPassword, newPassword) {
    return __awaiter(this, void 0, void 0, function () {
...
user_1["default"].methods.changeAccountStatus = function (status) {
    return __awaiter(this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
