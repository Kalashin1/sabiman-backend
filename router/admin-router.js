...
var validate_admin_1 = require("../controllers/admin/validate-admin");
...
exports.router.get('/admin', validate_admin_1.getAdmin);
exports.router.post('/admin/resetpassword/:id', admin_1.resetPassword);
