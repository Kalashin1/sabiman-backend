...
var createAgent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, phoneNumber, password, Agent, token, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, agent_1["default"].create({ name: name, phoneNumber: phoneNumber, password: password })];
            case 2:
                Agent = _b.sent();
                token = jwt_handler_1.createToken(Agent._id);
...
var loginAgentWithPhoneAndPassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, phoneNumber, password, Agent, token, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, agent_1["default"].login(phoneNumber, password)];
            case 2:
                Agent = _b.sent();
                console.log(Agent);
                token = jwt_handler_1.createToken(Agent._id) // create a token for that user
                ;
...
exports.loginAgentWithPhoneAndPassword = loginAgentWithPhoneAndPassword;
